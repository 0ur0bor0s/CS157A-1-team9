...
<html>
	...
	<body>
		<h1>Create User</h1>
		<b class='error'>Performer could not be created. Username or Performer Name already exists, or invalid Admin Code. Please try again.</b>
		<div class="login-info">
        	<form action="addperformer.jsp" method="post">
	        	<table style="width: 100%">
	        		...
	        		<tr>
	        			<td>Admin Code</td>
	        			<td><input type="password" name="adminCode" size="20" placeholder="12345"/></td>
	        		</tr>
	        		<tr>
	        			<td>Email</td>
	        		...
	        		<tr>
	        			...
	        			<td>
	        				<select name="performerType" id="performerType">
	        					<option value=""></option>
	        					<co:foreach items="${performerType}" var="value">
	        						<option>${value}</option>
	        					</co:foreach>
	        					</>
	        				</select>
